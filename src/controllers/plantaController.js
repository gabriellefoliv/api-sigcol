...
const getTempoRestante = async (codPlanta, tempoRega) => {
  ...
  if (agora < proximaRega) {
    ...
    const tempoRestanteTimestamp = new Date(tempoRestante).getTime();
    console.log("tempo : ", tempoRestanteTimestamp);
    return tempoRestanteTimestamp;
  }
};
